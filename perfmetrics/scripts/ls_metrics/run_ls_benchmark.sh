...
#then
python3 listing_benchmark.py config.json --gcsfuse_flags "$GCSFUSE_FLAGS" --branch "$BRANCH" --end_date "$END_DATE" --command "ls -R" --num_samples 30 --message "Testing CT setup."
#else
